...
int main( int argc, char ** argv )
{
    ...
    App::Application::Config()["ExeName"] = "YanhuaNC";
    App::Application::Config()["ExeVendor"] = "YanhuaNC";
    App::Application::Config()["AppDataSkipVendor"] = "true";
    App::Application::Config()["MaintainerUrl"] = "http://www.yanhuaweb.com";
    ...
    QGuiApplication::setDesktopFileName(QStringLiteral("org.freecadweb.YanhuaNC.desktop"));
#endif
